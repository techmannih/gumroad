...
describe AffiliatedProductsPresenter do
  ...
  describe "#affiliated_products_page_props", :vcr do
    ...
    let(:all_product_details) do
      [
        { id: ObfuscateIds.encrypt_numeric(creator_one_product_one.id),
          approved: true,
          fee_percentage: 15,
        ...
        { id: ObfuscateIds.encrypt_numeric(creator_one_product_two.id),
          approved: true,
          fee_percentage: 15,
          humanized_revenue: "$0",
        ...
        { id: ObfuscateIds.encrypt_numeric(global_affiliate_eligible_product.id),
          approved: true,
          fee_percentage: 15,
        ...
        { id: ObfuscateIds.encrypt_numeric(creator_two_product_two.id),
          approved: true,
          fee_percentage: 5,
        ...
        { id: ObfuscateIds.encrypt_numeric(creator_two_product_three.id),
          approved: true,
          fee_percentage: 25,
        ...
        { id: ObfuscateIds.encrypt_numeric(creator_two_product_four.id),
          approved: true,
          fee_percentage: 10,
          humanized_revenue: "$0",
        ...
        { id: ObfuscateIds.encrypt_numeric(global_affiliate_eligible_product_two.id),
          approved: true,
          fee_percentage: 10,
          humanized_revenue: "$0",
